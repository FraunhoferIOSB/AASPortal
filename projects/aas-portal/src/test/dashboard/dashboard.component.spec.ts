...
import { BehaviorSubject, first, mergeMap, of, Subject } from 'rxjs';
...
describe('DashboardComponent', () => {
    ...
    let cookie$: BehaviorSubject<string>;
    const chart1 = '42';
    const chart2 = '4711';
    // const chart3 = '0815';
    ...
    beforeEach(() => {
        ...
        cookie$ = new BehaviorSubject<string>('');
        const cookie = cookie$.asObservable();
        ...
        auth.getCookie.and.callFake(name => {
            if (name === '.DashboardPages') {
                cookie$.next(JSON.stringify(pages));
            } else {
                cookie$.next('Test');
            }
